package com.sky.books.order.servlet;

import com.sky.books.cart.domain.Cart;
import com.sky.books.cart.domain.CartItem;
import com.sky.books.order.domain.Order;
import com.sky.books.order.domain.OrderItem;
import com.sky.books.order.service.OrderException;
...
public class OrderServlet extends BaseServlet {
	...
	public void  add(HttpServletRequest request, HttpServletResponse response)
		...
		if(cart == null||(cartItems == null || cartItems.size() == 0)) {
		 ...
		 */
		service.add(order);
		System.out.println("订单===="+order.getOwner());
		/*
		 * 4. 保存order到request域，转发到/jsps/order.jsp
		 */
		...
		//response.sendRedirect(request.getContextPath() + "/jsps/order.jsp");
	}
	...
	public void myOrders(HttpServletRequest request, HttpServletResponse response)
		...
		if (user==null) {
			...
			request.getRequestDispatcher("/jsps/order_list.jsp").forward(request, response);
		}
	...
	public String pay(HttpServletRequest request, HttpServletResponse response)
		...
		String p3_Amt = "0.01";//request.getParameter("total")订单价格
		String p4_Cur = "CNY";
		String p5_Pid = "";
		String p6_Pcat = "";
		String p7_Pdesc = "";
	...
	public void back(HttpServletRequest request, HttpServletResponse response)
		 ...
		 */
		service.pay(r6_Order);//有可能对数据库进行操作，也可能不操作！
